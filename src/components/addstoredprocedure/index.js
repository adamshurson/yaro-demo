...
class AddStoredProcedure extends Component {
    ...
    render() {
        return (
            <div className="AddStoredProcedure flex items-center justify-center shadow-lg fixed pin bg-opaque z-30">
                <div className="absolute pin rounded bg-white flex flex-col p-4 m-4 md:m-12 lg:m-24">
                    ...
                    <button onClick={() => this.addProcedure()} className="flex p-4 rounded border-2 border-teal justify-center text-teal hover:text-white hover:bg-teal">Save</button>
                </div>
            </div>
        );
    }
